    ...
    <section className="contact-teaser">
      <div className="container">
        <div className="section-container">
            <h2 className="section-title" ref={h2Ref}>Have Questions?</h2>
            <img src="/underline.svg" style={{ width: h2Width }} />
        </div>
        <p className="contact-intro">We're here to help you on your publishing journey. Reach out to us with any questions or concerns.</p>
